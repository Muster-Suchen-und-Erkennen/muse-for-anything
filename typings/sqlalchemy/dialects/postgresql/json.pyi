...
ASTEXT = operators.custom_op("->>", precedence=idx_precedence, natural_self_precedent=True, eager_grouping=True)
JSONPATH_ASTEXT = operators.custom_op("#>>", precedence=idx_precedence, natural_self_precedent=True, eager_grouping=True)
...
class JSON(sqltypes.JSON):
    ...
    * Path index operations returning text (the ``#>>`` operator)::
    ...
    """
    astext_type = ...
    def __init__(self, none_as_null=..., astext_type=...) -> None:
