...
def dependency_for(modulename, add_to_all=...):
    ...
...
def coerce_kw_type(kw, key, type_, flexi_bool=..., dest=...):
...
class symbol(object):
    ...
    @classmethod
    def parse_user_argument(cls, arg, choices, name, resolve_symbol_names=...):
