...
class RelationshipProperty(StrategizedProperty):
    ...
    @util.deprecated_params(extension=("0.7", ":class:`.AttributeExtension` is deprecated in favor of the " ":class:`.AttributeEvents` listener interface.  The " ":paramref:`_orm.relationship.extension` parameter will be " "removed in a future release."))
    def __init__(self, argument, secondary=..., primaryjoin=..., secondaryjoin=..., foreign_keys=..., uselist=..., order_by=..., backref=..., back_populates=..., post_update=..., cascade=..., extension=..., viewonly=..., lazy=..., collection_class=..., passive_deletes=..., passive_updates=..., remote_side=..., enable_typechecks=..., join_depth=..., comparator_factory=..., single_parent=..., innerjoin=..., distinct_target_key=..., doc=..., active_history=..., cascade_backrefs=..., load_on_pending=..., bake_queries=..., _local_remote_pairs=..., query_class=..., info=..., omit_join=..., sync_backref=...) -> None:
    ...
    class Comparator(PropComparator):
        ...
        """
        _of_type = ...
        def __init__(self, prop, parentmapper, adapt_to_entity=..., of_type=...) -> None:
    ...
    def cascade_iterator(self, type_, state, dict_, visited_states, halt_on=...):
        ...
...
class JoinCondition(object):
    ...
    def join_targets(self, source_selectable, dest_selectable, aliased, single_crit=...):
    ...
    def create_lazy_clause(self, reverse_direction=...):
        ...
