...
class collection(object):
    ...
    @staticmethod
    @util.deprecated("1.0", "The :meth:`.collection.linker` handler is deprecated and will " "be removed in a future release.  Please refer to the " ":meth:`.AttributeEvents.init_collection` " "and :meth:`.AttributeEvents.dispose_collection` event handlers. ")
    def linker(fn):
...
class CollectionAdapter(object):
    ...
    def append_with_event(self, item, initiator=...):
    ...
    def remove_with_event(self, item, initiator=...):
    ...
    def clear_with_event(self, initiator=...):
    ...
    __nonzero__ = ...
    def fire_append_event(self, item, initiator=...):
    ...
    def fire_remove_event(self, item, initiator=...):
    ...
    def fire_pre_remove_event(self, initiator=...):
...
def bulk_replace(values, existing_adapter, new_adapter, initiator=...):
...
__canned_instrumentation = { list: InstrumentedList,set: InstrumentedSet,dict: InstrumentedDict }
__interfaces = { list: ({ "appender": "append","remover": "remove","iterator": "__iter__" }, _list_decorators()),set: ({ "appender": "add","remover": "remove","iterator": "__iter__" }, _set_decorators()),dict: ({ "iterator": "values" }, _dict_decorators()) if util.py3k else ({ "iterator": "itervalues" }, _dict_decorators()) }
class MappedCollection(dict):
    ...
    @collection.appender
    @collection.internally_instrumented
    def set(self, value, _sa_initiator=...):
        """Add an item by value, consulting the keyfunc for the key."""
        ...
    
    @collection.remover
    @collection.internally_instrumented
    def remove(self, value, _sa_initiator=...):
