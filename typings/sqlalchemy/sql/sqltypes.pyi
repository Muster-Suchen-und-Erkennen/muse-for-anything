...
@util.deprecated_cls("0.6", "The :class:`.Binary` class is deprecated and will be removed " "in a future relase.  Please use :class:`.LargeBinary`.")
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine):
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    class Comparator(Indexable.Comparator, Concatenable.Comparator):
        ...
        def any(self, elements, other, operator=...):
        ...
        @util.dependencies("sqlalchemy.sql.elements")
        def all(self, elements, other, operator=...):
...
INTEGERTYPE = Integer()
MATCHTYPE = MatchType()
_type_map = { int: Integer(),float: Float(),bool: BOOLEANTYPE,decimal.Decimal: Numeric(),dt.date: Date(),dt.datetime: DateTime(),dt.time: Time(),dt.timedelta: Interval(),util.NoneType: NULLTYPE }
if util.py3k:
    ...
else:
    ...
