...
from operator import add, and_, div, eq, ge, getitem, gt, inv, le, lt, mod, mul, ne, neg, or_, sub, truediv
from .. import util
...
class Operators(object):
    ...
    def op(self, opstring, precedence=..., is_comparison=..., return_type=...):
    ...
    def bool_op(self, opstring, precedence=...):
...
class ColumnOperators(Operators):
    ...
    def notilike(self, other, escape=...):
...
@comparison_op
def notbetween_op(a, b, c, symmetric=...):
    ...
...
@comparison_op
def notstartswith_op(a, b, escape=..., autoescape=...):
    ...
...
@comparison_op
def notendswith_op(a, b, escape=..., autoescape=...):
    ...
...
@comparison_op
def notcontains_op(a, b, escape=..., autoescape=...):
    ...
