...
class TestNestedMigration(unittest.TestCase):
    ...
    def test_object_to_object(self):
        ...
        self.assertTrue(DataMigrator.check_schema_changes(source_schema, target_schema))
    ...
    def test_self_recursive_schema(self):
        unresolved_local_schema = JsonSchema(
            _ROOT_URL,
            {
                "$ref": "#/definitions/root",
                "$schema": "http://json-schema.org/draft-07/schema#",
        ...
        valid = DataMigrator.check_schema_changes(
            unresolved_local_schema, unresolved_local_schema
        )
